...
* Адреса инструкций виртуального процессора вычисляются арифметически, без
использования таблиц, множественных условных переходов, или модификации байт-кода
(режим `THREADED_CODE`), как в оригинальной реализации. Такой подход потенциально
позволяет сократить размер простых инструкций с четырёх байт до одного,
...
реализацией (версия 4.04.2, каталог `ocaml/testsuite/testsuite/tests/`):
